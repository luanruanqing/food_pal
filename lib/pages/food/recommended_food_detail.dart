...
import 'package:food_pal/widgets/expandable_text_widget.dart';
...
class RecommendedFoodDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // print("height and width:"+MediaQuery.of(context).size.height.toString()+" and "+MediaQuery.of(context).size.width.toString());
    var product =

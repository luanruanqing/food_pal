...
import 'package:food_pal/widgets/icon_and_text_widget.dart';
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                height: Dimensions.listViewContextSize,
                                decoration: BoxDecoration(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SmallText(text: "${recommendedProduct
                                          .recommendedProductList[index]
                                          .location!}"),
                                      SizedBox(
                                        height: Dimensions.height10,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Wrap(
                          children: List.generate(popularProduct.stars!, (index) {
                            return Icon(
                              Icons.star,
                              color: AppColors.mainColor,
                              size: 15,
